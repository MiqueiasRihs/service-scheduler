# Generated by Django 4.2.4 on 2023-11-02 17:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL, verbose_name='Profissional')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('professional', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='professional_services', to='professional.professional', verbose_name='Profissional')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_time', models.TimeField(verbose_name='Hora de início')),
                ('end_time', models.TimeField(verbose_name='Hora de término')),
                ('working_plan', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='breaks', to='professional.workingplan')),
            ],
            options={
